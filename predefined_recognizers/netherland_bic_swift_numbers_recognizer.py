...
class NetherlandsBICSwiftRecognizer(PatternRecognizer):
    ...
    # Define patterns for Netherlands BIC/SWIFT Numbers (8 or 11 characters)
    PATTERNS = [
        Pattern(
            "Netherlands BIC/SWIFT - 8 Characters",
            r"\b[A-Za-z]{4}NL[A-Za-z0-9]{2}\b",  # Pattern for 8-character BIC/SWIFT: 4 letters + 'NL' + 2 alphanumeric
            0.5  # Initial confidence score for the pattern match
        ),
        Pattern(
            "Netherlands BIC/SWIFT - 11 Characters",
            r"\b[A-Z]{6}[A-Z0-9]{2}\b",  # Pattern for 11-character BIC/SWIFT: 4 letters + 'NL' + 5 alphanumeric
            0.5  # Initial confidence score for the pattern match
        ),
        Pattern(
            "Netherlands BIC/SWIFT - 11 Characters",
            r"\b[A-Z]{6}[A-Z0-9]{5}\b",  # Pattern for 11-character BIC/SWIFT: 4 letters + 'NL' + 5 alphanumeric
            0.5  # Initial confidence score for the pattern match
        )
    ]
    ...
    def __init__(
        ...
        supported_language: str = "en",  # Supports English and Dutch
